  ...
  return (
    <div className="dashboard-layout">
      ...
      <main className="dashboard-content">
        ...
        <section className={`dashboard-charts-row  ${(userType === 8 || userType === "8") ? "display-none" : ""}`}>
        ...
        <section className={`${(userType === 1 || userType === 2 || userType === 3) ? "display-none" : ""}`}>
          <div className="dashboardcomplaints-table-card">
            ...
            <div className="dashboardcomplaints-table-responsive">
              <table className="dashboardcomplaints-table">
                ...
                <tbody>
                  {allComplaintsShowDirector.length > 0 ? (
                    allComplaintsShowDirector.slice(0, entries).map((row, idx) => (
                      <tr key={idx}>
                        <td>
                          <a
            ...
            <div className="dashboardcomplaints-table-footer" style={{ marginTop: 16 }}>
...
const Card = ({ title, value, icon, accent, onClick, activecount, inactivecount }) => {
  ...
  return (
    <div>
      {(userType === "1" || userType === 1) && (
        ...
        >
          ...
          <div>
            ...
            {(title === "Dealer" || title === "Staff" || title === "Branch") && (
              <>
      ...
      {(userType === "9" || userType === 9) && (
        <div>

        </div>
      )}
      {(userType === "10" || userType === 10) && (
        <div>
