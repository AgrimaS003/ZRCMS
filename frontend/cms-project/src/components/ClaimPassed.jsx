...
const ClaimPassed = () => {
  ...
  useEffect(() => {
    ...
    fetch(`http://192.168.1.32:5015/${usertype}/claim_passed`, {
      method: 'POST',
      headers: {
      ...
      .then((data) => {
        if (data.success) {
          ...
          console.error('Failed to fetch claim passed complaints:', data.message || data.error_msg);
        }
        setLoading(false);
      })
      .catch((err) => {
        console.error('Error fetching claim passed complaints:', err);
        setLoading(false);
      });
  }, [userEmail, usertype]);
    ...
    <div>
      ...
      <main>
        ...
        <div className="complaint-table">
          <p id="complaint-table-p">Claim Passed</p>
                ...
                {paginatedComplaints.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan="4" style={{ textAlign: 'center' }}>
                      No claim passed complaints found
                    </td>
                  </tr>
                )}
              </tbody>
